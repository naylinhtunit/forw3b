                            ...
                            <div class="x_title">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <form action="{{ route('search') }}" method="get">
                                        <div class="pull-left">
                                            <input type="search" name="search" placeholder="Name" class="form-control">
                                        </div>
                                        <div class="pull-left">
                                ...
                                <div class="pull-right">
                                    <a href="{{ url('/panel/post/create') }}" class="btn btn-success"> Add post </a>
                                </div>
                            ...
                            <table class="table table-striped projects">
                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ url('/panel/post', $post->id) }}" method="post">
                                                <a href="{{ url('panel/post/edit', $post->id) }}" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                @csrf
                                                @method('DELETE')
