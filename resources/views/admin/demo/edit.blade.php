            ...
            <div class="x_panel">
                ...
                <form method="post" action="{{ url('panel/blog', $demos->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <input name="image" type="file" id="input-file-now" data-default-file="{{ URL::to('/') . '/img/blog/demo/' . $demos->image }}" data-allowed-file-extensions="png jpg jpeg svg" class="dropify" />    
                    </div>
